...
#ifdef DB_CARDREADER
static int  initDevice(struct state_st* const s, bool dev_flg)
#else
...
#ifdef DB_CARDREADER
static int  sleepDevice(struct state_st* const s, bool dev_flg)
#else
...
#ifdef DB_CARDREADER
int em287x_create(em287x_state* const  state, struct usb_endpoint_st * const pusbep, bool dev_flg)
#else
...
#ifdef DB_CARDREADER
int em287x_destroy(const em287x_state state, bool dev_flg)
#else
